...
function TripCard({
  ...
  return (
    <article className="surface rounded-lg overflow-hidden">
      ...
      >
        <div className="flex-1 min-w-0">
          <p className="text-sm font-semibold text-ink truncate">
            {formatDate(trip.purchased_at)}
          </p>
          <p className="text-[.68rem] text-ink-faint">
      ...
      {open && (
        <div className="border-t border-[rgba(21,49,49,0.06)] px-3 py-2 space-y-1">
          {items.map((i) => (
            <div key={i.id} className="flex items-baseline gap-2 text-[.72rem]">
          ...
          <div className="flex gap-1 pt-2 border-t border-[rgba(21,49,49,0.06)]">
            <button
              onClick={handleShare}
              className="flex items-center gap-1 px-2 py-1.5 rounded-md
                text-[.68rem] text-brand-600 font-medium"
            >
              <Share2 size={12} />
              Compartir
            </button>
            <button
              ...
              className="flex items-center gap-1 px-2 py-1.5 rounded-md
                text-[.68rem] text-rose-500 font-medium ml-auto"
            >
              <Trash2 size={12} />
              Eliminar
            </button>
...
export default function PurchaseHistory({
  ...
  return (
    <div className="space-y-2">
      <p className="text-[.68rem] text-ink-faint px-0.5">
